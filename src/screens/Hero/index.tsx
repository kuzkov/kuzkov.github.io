...
import ExternalLinks from '@values/ExternalLinks';
    ...
    <Container maxW="container.lg" mt="8">
      <Box mt="24" px={[4, 4, 8]} w={['100%', '100%', '70%']}>
        ...
        <Text mt="2">
          ...
          <Link color="teal.500" href={ExternalLinks.TELEGRAM} isExternal>
            telegram
          </Link>{' '}
          or{' '}
          <Link color="teal.500" href={ExternalLinks.MAIL} isExternal>
            email
          </Link>
          ,{' '}
          <Link color="teal.500" href={ExternalLinks.GITHUB} isExternal>
            my github page
          </Link>
        </Text>
        <HStack mt="4">
          <Button colorScheme="teal" as="a" href={ExternalLinks.TELEGRAM}>
            Contact me
          </Button>
          <Button
            colorScheme="teal"
